                ...
                <div class="panel-body">
                  <form:form action="RegisterAttempt" method="POST" modelAttribute="userDetails"  role="form">
                    ...
                    Credit Card details *
                      ...
                      <form:input path="cardDetails.cardNumber" type="text" class="form-control" name="cardNumber" required="required"/>
                      <form:label path="cardDetails.name">Name on card *</form:label>
                      <form:input path="cardDetails.name" type="text" class="form-control" name="name" required="required"/>                      <form:label path="cardDetails.cvv">CVV *</form:label>
                      <form:label path="cardDetails.cvv">CVV *</form:label>
                      <form:input path="cardDetails.cvv" type="text" class="form-control" name="cvv" required="required"/>
                      <form:select path="cardDetails.expiryMonth" items="${monthList}"/>
                      <form:select path="cardDetails.expiryYear" items="${yearList}"/>
                    </div>
                    <div class="form-group">
