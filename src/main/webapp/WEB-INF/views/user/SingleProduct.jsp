              ...
              <div class="media">
                ...
                <div class="media-body">
                  <ul class="list-inline">
                    <li><a href="Home"><i class="fa fa-reply" aria-hidden="true"></i>Continue Shopping</a></li>
                  ...
                  <span class="quick-drop">
                    <select name="guest_id3" id="guest_id3" class="select-drop">
                  ...
                  <span class="quick-drop resizeWidth">
                    <select name="guest_id4" id="guest_id4" class="select-drop">
