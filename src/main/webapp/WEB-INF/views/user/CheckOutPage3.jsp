                        ...
                        <table class="table">
                          ...
                          <tbody>
                            <c:forEach items="${orderList}" var="order" varStatus="status">
										<tr>
											<td class="col-xs-2">
											<span class="cartImage"><img src="resources/images/products/${productList[status.index].id}.jpg" alt="image"></span>
											</td>
											...
											<td class="col-xs-2">$${productList[status.index].price * order.quantity}</td>
										</tr>
							</c:forEach>
                          </tbody>
                        </table>
