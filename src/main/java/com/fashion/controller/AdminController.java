...
public class AdminController
{
	...
	public String editProductAttempt(@ModelAttribute("product") Product product, HttpServletRequest request,
			Model model)
	{
	...
	public ModelAndView adminProductList(@RequestParam(value = "category", required = false) String category,
